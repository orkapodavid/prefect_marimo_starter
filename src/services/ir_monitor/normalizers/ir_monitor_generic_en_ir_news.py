"""Normalize English IR news pages into stable lines."""
...
def normalize(content: str, page_url: str) -> str:
    """Normalize an English IR listing page into sorted item lines."""
    ...
    for link in soup.find_all("a", href=True):
        ...
        if container is not None:
            date_node = container.find("time") or container.find(["span", "p"], class_="date")
